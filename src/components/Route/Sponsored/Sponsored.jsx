      ...
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            ...
            style={{ width: "150px", objectFit: "contain" }}
            alt="alternate_img_dell"
          />
        </div>
        <div className="flex items-start">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3eGcu0urRCx2noaVZYwH6MrSk2sSweqB-ww&usqp=CAU"
            style={{ width: "150px", objectFit: "contain" }}
            alt="alternate_img"
          />
        </div>
