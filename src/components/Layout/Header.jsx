  ...
  return (
    <>
      <div className={`${styles.section}`}>
        {/* hidden */}
        <div className=" hidden 800px:flex  800px:h-[50px] 800px:my-[20px]  items-center justify-between">
          <div>
            <Link to="/">
              <img
          ...
          {/* search box */}
          <div className="w-auto 800px:w-[50%] relative">
            <input
              type="text"
      ...
      <div className="w-full h-16 flex bg-white z-50 top-0 left-0 shadow-sm 800px:hidden">
        ...
        {
          open && (
            <div className="fixed w-full bg-[#0000005f] z-20 f-full top-0 left-0">
              <div className="fixed w-2/3 bg-white h-screen top-0 left-0 z-10">
